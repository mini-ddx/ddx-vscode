...
/**
 * Map a range from actual `.ddx` file to `.ddx.template` file
 */
...
/**
 * Map an offset from actual `.ddx` file to `.ddx.template` file
 */
...
/**
 * Map a range from virtual `.ddx.template` file back to original `.ddx` file
 */
